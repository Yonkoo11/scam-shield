    ...
    <div className="container max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="font-display text-7xl md:text-8xl leading-[0.85] tracking-tight mb-6">
          <span className="text-[#0a0a0a] block animate-slide-in-left">DON&apos;T</span>
          <span className="bg-[#0a0a0a] text-white px-3 inline-block my-2 brutal-shadow-sm animate-slide-in-left stagger-1">GET</span>
          <br />
        ...
        <p className="text-lg text-[#525252] mb-5 max-w-md mx-auto animate-slide-in-left stagger-3">
          AI-powered scam detection. Paste anything suspicious and become immune.
        </p>

        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border-2 border-[#0a0a0a] text-sm font-bold animate-scale-in stagger-4">
          <Sparkles className="w-4 h-4 text-[#4285F4]" />
          <span className="text-[#525252]">Powered by</span>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-center gap-2 mb-5">
          ...
          <span className="font-display text-sm tracking-widest text-[#525252] uppercase">How It Works</span>
          <div className="h-[2px] w-8 bg-[#0a0a0a]" />
        </div>

        <div className="grid grid-cols-3 gap-3">
          <div className="brutal-card p-4 text-center brutal-shadow-sm">
            <div className="w-10 h-10 bg-[#facc15] border-3 border-[#0a0a0a] flex items-center justify-center mx-auto mb-3">
              <ClipboardPaste className="w-5 h-5 text-[#0a0a0a]" />
            </div>
            <div className="font-display text-2xl text-[#0a0a0a] mb-1">1. PASTE</div>
            <p className="text-[11px] text-[#525252] leading-tight">Copy any suspicious message, email, or screenshot</p>
          </div>
          <div className="brutal-card p-4 text-center brutal-shadow-sm">
            <div className="w-10 h-10 bg-[#ef4444] border-3 border-[#0a0a0a] flex items-center justify-center mx-auto mb-3">
              <ScanSearch className="w-5 h-5 text-white" />
            </div>
            <div className="font-display text-2xl text-[#0a0a0a] mb-1">2. SCAN</div>
            <p className="text-[11px] text-[#525252] leading-tight">Gemini AI analyzes for 50+ manipulation tactics</p>
          </div>
          <div className="brutal-card p-4 text-center brutal-shadow-sm">
            <div className="w-10 h-10 bg-[#22c55e] border-3 border-[#0a0a0a] flex items-center justify-center mx-auto mb-3">
              <GraduationCap className="w-5 h-5 text-white" />
            </div>
            <div className="font-display text-2xl text-[#0a0a0a] mb-1">3. LEARN</div>
            <p className="text-[11px] text-[#525252] leading-tight">Get a verdict, understand the tactics, become immune</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 mb-4">
        <div className="flex items-center justify-center gap-2 mb-5">
          <div className="h-[2px] w-8 bg-[#0a0a0a]" />
          <span className="font-display text-sm tracking-widest text-[#525252] uppercase">Explore More</span>
          <div className="h-[2px] w-8 bg-[#0a0a0a]" />
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <Link href="/about" className="brutal-card p-4 text-center brutal-shadow-sm group">
            ...
            <p className="font-display text-lg text-[#0a0a0a]">ABOUT GEMINI</p>
            <p className="text-[10px] text-[#525252] mb-2">How AI protects you</p>
            <ArrowRight className="w-4 h-4 mx-auto text-[#0a0a0a] group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
      </div>
